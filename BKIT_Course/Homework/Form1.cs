...
namespace Homework
{
    public partial class Form1 : Form
    {
        ...
        private void buttonLoadFile_Click(object sender, EventArgs e)
        {
            ...
            if (fd.ShowDialog() == DialogResult.OK)
            {
                ...
                foreach (string strTemp in textArray)
                {
                    ...
                    if (!list.Contains(str)) list.Add(str); //Добавление строки в список, если строка не содержится в списке
                }
        ...
        private void buttonExact_Click(object sender, EventArgs e)
        {
            ...
            string word = this.textBoxFind.Text.Trim(); //Слово для поиска
